...
massy=[0,0,0, 0,-(29800*masses[1]/masses[0]),0,  1.49597e11,0,0, 0,29800,0]
DRO=1.2
zeromass=[DRO*AU,0,0,0,29800/sqrt(DRO),0]
...
T = 0
for q in range(365*24*6*(3600/dt)):
 ...
 print T,ug,v1,v2,universe[1][9],universe[1][10],universe[1][6],universe[1][7],universe[2][0],universe[2][1],universe[2][3],universe[2][4]
